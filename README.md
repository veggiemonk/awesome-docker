...
- [pocok](https://pocok.io/) - Autocompletion and syntax highlighting for Docker commands. Pocok will help you to organise and manage Docker, Docker-Compose, Kubernetes projects of any complexity using simple YAML config files to shorten the route from finding your project to initialising it in your local environment.
