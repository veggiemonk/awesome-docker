...
* [Random Logger](https://github.com/chentex/random-logger) - Generates random log messages in the container, useful to test log forwarding configurations. [@chentex](https://github.com/chentex)
