...
* [Docker for all - Developers, Testers, DevOps, Product Owners + Videos](https://github.com/machzqcq/docker-for-all.git) - [Summary](https://www.linkedin.com/pulse/docker-training-course-all-welcome-pradeep-macharla) 
