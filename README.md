...
-   [docker-run-to-compose](https://devutils.lol/tools/docker-run-to-compose) - Converts docker run commands to docker-compose and Kubernetes manifests, by [@sunanda35](https://github.com/sunanda35)
