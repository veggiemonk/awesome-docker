...
-   [duplicacy-cli-cron](https://github.com/GeiserX/duplicacy-cli-cron) - Automated encrypted dual-storage backup orchestration using Duplicacy CLI with cross-site redundancy, per-repo locking, and Telegram notifications. By [@GeiserX](https://github.com/GeiserX)
