...
-   [DockStat](https://github.com/its4nik/dockstat) - :construction: DockStat is a Docker monitoring solution, I am actively working on DockStatAPI-v2 which will add features like stack management, graph generation, and more! by [its4nik](https://github.com/its4nik)
