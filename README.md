...
- [skill-audit-mcp](https://github.com/eltociear/skill-audit-mcp) - Static security scanner for MCP servers, AI agent skills, and plugins. 68 attack patterns across 4 severity levels — credential exfiltration, prompt injection, code execution, seed-phrase harvesting, auth bypass, path traversal. Multi-arch container at `ghcr.io/eltociear/skill-audit-mcp`, SARIF output for GitHub Code Scanning, also a GitHub Action. Zero dependencies. By [eltociear](https://github.com/eltociear).
