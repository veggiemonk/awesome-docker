...
- [Server Audit](https://github.com/Secure-Code-HQ/audit) - Detects Docker security misconfigurations on Linux VPS servers, including UFW/iptables bypass, exposed Docker socket, and containers running as root.
