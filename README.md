...
- [envsetup.dev](https://github.com/kbrahmateja/v0-envsetup-dev) - Generates a Dockerfile, docker-compose.yml, and .env.example for 23+ languages and frameworks via a CLI (`npx @envsetup/cli init`) or web UI.
