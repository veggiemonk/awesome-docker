...
- [Portwing](https://github.com/CodesWhat/portwing) - Proxies the Docker daemon socket to a remote controller with per-request Ed25519 signing, and an outbound-only edge mode that opens no inbound port.
