...
-   [Shimmy](https://github.com/Michael-A-Kuykendall/shimmy) - Self-hosted AI inference server with OpenAI API compatibility. Fast, lightweight container supporting multiple model formats (GGUF, Core ML, etc.) with built-in streaming and multimodal capabilities. By [@Michael-A-Kuykendall](https://github.com/Michael-A-Kuykendall)
