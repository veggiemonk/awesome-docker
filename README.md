...
- [Den](https://github.com/us/den) - Self-hosted sandbox runtime for AI agents. Creates isolated Docker containers with dropped capabilities, read-only rootfs, and PID limits. Features dynamic memory pressure management, REST API, and WebSocket support. By [us](https://github.com/us).
