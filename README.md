...
- [error-pages](https://github.com/tarampampam/error-pages) - Tiny, zero-dep HTTP server & Docker image serving pretty, themeable, localized HTTP error pages — drop-in for Traefik, Nginx, Kubernetes, and more. By [tarampampam](https://github.com/tarampampam).
