...
- [DoctorDock](https://github.com/iamcanturk/DoctorDock) - Local-first, offline diagnostics for a running Docker environment: flags security misconfigurations (exposed socket, containers as root, sensitive published ports) and reclaimable resources, and reports a health score with copy-paste fixes.
