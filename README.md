...
* [SCAR](https://github.com/grycap/scar) - Serverless Container-aware ARchitectures (SCAR) is a serverless framework that allows easy deployment and execution of containers in Serverless environments i.e. Lambda (SCAR) by [@grycap](https://github.com/grycap)
